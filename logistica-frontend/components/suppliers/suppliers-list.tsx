...
export function SuppliersList({ onEdit, onDelete, onCreate }: Props) {
  ...
  const canWrite = canAccess("suppliers", "write", groups, permissions, isSuperuser)
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center gap-4 py-20">
        <p className="text-white/50">Error al cargar proveedores</p>
  ...
  return (
    <div className="space-y-4">
      <DataTableToolbar
        title="Proveedores"
        searchPlaceholder="Buscar por empresa, contacto, email o ciudad..."
        searchValue={search}
